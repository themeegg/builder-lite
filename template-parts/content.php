...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
    <div class="blog-wrapper blog-list wow fadeInUp animated" data-wow-delay="0.2s"><?php
        ...
        <div class="meta-wrapper">
            <div class="meta"><?php
                ...
                <span class="meta-item">
                    <i class="fa fa-commenting"></i><a class="post-comments-url" href="<?php the_permalink() ?>#comments"><?php comments_number( '0', '1', '%' ); ?> <?php esc_html_e( 'Comments', 'builder-lite' ); ?></a>
                </span>
            </div>
        </div>
		...
		if ( ! is_single() ) {?>
            <a class="builder-btn readmore"
               href="<?php the_permalink() ?>"><?php esc_html_e( 'Read more', 'builder-lite' ); ?></a><?php
		}?> <?php
		wp_link_pages(
             array(
